...
public class Usuario extends Persona {
    ...
    protected Tienda carrito = new Tienda();
    ...
    private boolean validatePassword(String password, String rePassword) throws Password {
        if(!password.equals(rePassword)) {
            throw new Password("Tus claves no cohinciden. Intenta de nuevo...\n");
        } else {
            return true;
        }
    }
